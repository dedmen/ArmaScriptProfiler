...
HookManager::Pattern pat_frameEnd{
    "xxxxxxxxxxxxxxxxxxxxxxxx????xx?????xxxxxxxxxxxxxxxxx????xxxxxxx????xx????xxxx????xxxxxxx????xx????xxxxxxxxxxx????x????xxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxx?????xx????xx",
    ""
};


//Not real doend
HookManager::Pattern pat_doEnd{
    "xxxxxx????xxx?????xxx????xxxxxxxxxxxxxxxxx????x????xxxxxxxxxxx????xxxxx",
//                                             ^^^^ that's it
...
HookManager::Pattern pat_scopeCompleted{
    "xxxxxxxxxxxxxxxxxxxxxxxxx????xx????xxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxx",
    ""
};

HookManager::Pattern pat_shouldTime{
    "xxxxxxxxxxxxxxxxxxxxxxxxxx????xxxxxxxxxx",
    "\x8B\x44\x24\x04\x8B\x48\x0C\x85\xC9\x78\x25\x8B\x10\x31\xC0\x85\xD2\x74\x15\x80\x3A\x00\x74\x10\x69\xC9\x00\x00\x00\x00\x03\x4A\x20\x74\x05\x0F\xB6\x41\x4A\xC3"
};

#else

HookManager::Pattern pat_frameEnd{
    "xxxxxxxxxxxxxxxxx????xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx?xxxxx?????x????xxxxxxxxx????xx????xxxx?xxxxxxxx????xx????xx?????x????xxx????xx????xx????xxxxxxxx????xxx????xxxxx????xxxxxxxxxxxxxxxxxxxxxxx",
    ""
};
